...
<html>
  <head>
    ...
    <title>Portafolio Sonora Online Security</title>
  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="#references" class="navbar-brand scrollTo">Sonora Online Security</a>
          <button type="button" data-toggle="collapse" data-target="#navbarcollapse" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right"><span class="fa fa-bars"></span></button>
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                         <li class="nav-item"><a href="#references" class="nav-link link-scroll">#CiberSecurity</a></li>
      ...
      <div class="container">
        <div class="col-sm-12">
          <div class="mb-5 text-center">
            <h2 data-animate="fadeInUp" class="title">Herramientas</h2>
            <p data-animate="fadeInUp" class="lead">Algunas Herramientas de Hacking Que utilizamos en el equipo.</p>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-center text-lg-right mt-4 mt-lg-0">
            <p>© <?php echo date('Y');?> Sonora Online Security. All rights reserved.</p>
          </div>
          <div class="col-12 mt-4">
            <p class="template-bootstrapious">Designed by <a href="https://www.bootstrapious.com">Sonora Online Security</a>
